                ...
                <div className="container">
                    <div className="layout">
                        <div className="content-difference">
                            <h3 className="title-difference js-reveal-on-scroll js-split-to-lines">Speed-to-Impact</h3>
                            <p className="paragraph-difference js-reveal-on-scroll js-split-to-lines">We’re about speed-to-impact and ROI. Our cloud-based solution is easy to implement, easy to administer, and easy for leaders and teams to use in the flow of work. Whether for a single leader and team, a business unit, or the entire enterprise, our flexible solution scales based on your needs.</p>
                        </div>
