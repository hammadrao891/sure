...
import PartnersScroller from '../../components/PartnersScroller/Partners/PartnersScroller'
import PartnersSolution from '../../components/PartnersSolution/PartnersSolution'
import PartnersCTA from '../../components/PartnersCTA/PartnersCTA'

const Partners = () => {
    useEffect(() => {
        // Function to handle tab section
        const tabsSection = () => {
        ...
        tabsSection(); // Call the tab section function
       ...
       handleLottieAnimations(); // Call the handle Lottie animations function
       handleSplitToLines()
       handleRevealCTA()
